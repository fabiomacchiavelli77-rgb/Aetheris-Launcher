# Context compattato per LM Studio (Qwen2.5-Coder-14B/32B-abliterated)

# Budget richiesto: 30000 token | Stimato attuale: ~7236 token | Caratteri: 28942



## FILE: AGENTS.md  (~3077 tok)
...
## FILE: ClientCore/src/main/java/net/aetheris/client/modules/ModuleManager.java  (~1080 tok)
