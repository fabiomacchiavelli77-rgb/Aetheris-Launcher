...
import kaptainwutax.seedcrackerX.cracker.SlimeChunkCracker;
...
public class DataStorage {
    ...
    protected ScheduledSet<Entry<SlimeChunkData>> slimeChunkData = new ScheduledSet<>(null);
    protected SlimeChunkCracker slimeChunkCracker = new SlimeChunkCracker(null);
    ...
    public synchronized boolean addSlimeChunkData(SlimeChunkData data, DataAddedEvent event) {
        Entry<SlimeChunkData> e = new Entry<>(data, event);

        if (this.slimeChunkData.contains(e)) {
            return false;
        }

        this.slimeChunkData.scheduleAdd(e);
        this.slimeChunkCracker.addChunk(data);
        this.schedule(event::onDataAdded);
        return true;
    }

    public SlimeChunkCracker getSlimeChunkCracker() {
        return this.slimeChunkCracker;
    }
    ...
    public void clear() {
        ...
        this.slimeChunkData = new ScheduledSet<>(null);
        this.slimeChunkCracker = new SlimeChunkCracker(null);
